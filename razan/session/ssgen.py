...
def telethon_session():
    ...
    # logging in
    try:
        with TelegramClient(StringSession(), API_ID, API_HASH) as olga:
            print("Generating a string session for • bidu •")
            try:
                olga.send_message(
                    "me",
        ...
        print(er)
        print("If you think It as a Bug, Report to @sorsLGG\n\n")
