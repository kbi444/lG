...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if PM_WARNS[str(chat.id)] >= MAX_FLOOD_IN_PMS:
        ...
        if custompmblock is not None:
            ...
            USER_BOT_WARN_ZERO = f"— يعني ما ادري انت تفهم او لا قلت لا ترسل اكثر من {totalwarns} بس مدري يلا انتظر المالك يفك الحظر ."
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ُ— هلا {mention} .\n— صاحب الحساب مشغول ، نايم ، ما يريد يرد هذا شي راجع له .\n— مهمتي ازعج الخاص من الازعاج والسبام .\n عندك : {warns}  تحذير .\n من اصل : {totalwarns} .\nاذا اكتمت التحذيرات رح تنحظر يحلو 🙂."""
    else:
        USER_BOT_NO_WARN = f"""ُ— هلا {mention} .\n— صاحب الحساب مشغول ، نايم ، ما يريد يرد هذا شي راجع له .\n— مهمتي ازعج الخاص من الازعاج والسبام .\n عندك : {warns}  تحذير .\n من اصل : {totalwarns} .\nاذا اكتمت التحذيرات رح تنحظر يحلو 🙂."""
...
- هذه الخيارات في الاسفل اختر واحد فقط ⬇️"""
    buttons = [
        ...
        (Button.inline(text="لاقوم بازعاج مالك الحساب",data="to_spam_my_master_inbox",),),
    ]  
