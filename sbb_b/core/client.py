...
class olgaClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/sorsLGG)"
                        text = "**تقرير خطأ سورس LG**\n\n" + "اذا اردت يمكنك التبليغ"
...
olgaClient.fast_download_file = download_file
olgaClient.fast_upload_file = upload_file
olgaClient.reload = restart_script
olgaClient.get_msg_link = get_message_link
olgaClient.check_testcases = checking

try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    olgaClient.send_message = send_message
    olgaClient.send_file = send_file
    olgaClient.edit_message = edit_message
